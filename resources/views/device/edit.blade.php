    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form name="deviceAddForm" method="POST" action="{{ route('devices.update',['device'=>$device->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="Device location">Device location</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="Device location" name="Device location"
                                    placeholder="Server name" value="{{ old('Device location', $device->Device location) }}" />
                            </div>
                        </div>
